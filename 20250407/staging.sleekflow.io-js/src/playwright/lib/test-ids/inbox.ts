export const INBOX_TEST_IDS = {
  ...
  inboxAiEnrichmentContent: 'inbox-ai-enrichment-content',
  ...
  inboxConversationInputReplyTab: 'inbox-conversation-input-reply-tab',
  ...
  inboxConversationInputProductCatalogStoreMenuItem: (id: string) =>
    `inbox-conversation-input-product-catalog-store-menu-item-${id}`,
  inboxConversationInputProductCatalogProductName: (id: string) =>
    `inbox-conversation-input-product-catalog-product-name-${id}`,
  inboxConversationInputProductCatalogProductPrice: (id: string) =>
    `inbox-conversation-input-product-catalog-product-price-${id}`,
  ...
  inboxConversationInputReplyEditorOverlayEnterMessageButton:
    'inbox-conversation-input-reply-editor-overlay-enter-message-button',
  inboxConversationInputProductCatalogSearchInput:
    'inbox-conversation-input-product-catalog-search-input',
  inboxConversationInputProductCatalogLanguageSelector:
    'inbox-conversation-input-product-catalog-language-selector',
  inboxConversationInputProductCatalogLanguageSelectorElement: (
    language: string,
  ) => `inbox-conversation-input-product-catalog-language-selector-${language}`,
  inboxConversationInputProductCatalogCurrencySelector:
    'inbox-conversation-input-product-catalog-currency-selector',
  inboxConversationInputProductCatalogCurrencySelectorElement: (
    currency: string,
  ) => `inbox-conversation-input-product-catalog-currency-selector-${currency}`,
  inboxConversationInputProductCatalogGeneratePaymentLinkButton:
    'inbox-conversation-input-product-catalog-generate-payment-link-button',
} as const;
