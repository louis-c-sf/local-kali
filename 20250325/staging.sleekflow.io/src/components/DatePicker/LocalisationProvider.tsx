...
import type { MuiPickersAdapter } from '@/components/DatePicker/hooks/useUtils';

export const MuiPickersAdapterContext =
  React.createContext<MuiPickersAdapter | null>(null);
...
const LocalizationProvider: React.FC<LocalizationProviderProps> = (props) => {
  ...
  return (
    <MuiPickersAdapterContext.Provider value={utils}>
      {children}
