...
import { c as WorkflowTestActivityMessageStatus, a as WorkflowPersistenceBehavior } from './domain-a7b2c384.js';
...
import { f as featuresDataManager } from './features-data-manager-c2ff7310.js';
...
import { T as Tunnel$1 } from './dashboard-c6e2b698.js';
import { L as LayoutDirection, W as WorkflowDesignerMode } from './models-bd23e9a1.js';
...
let ElsaWorkflowDefinitionEditorScreen = class {
  constructor(hostRef) {
    ...
    this.renderTestActivityMenu = () => {
      ...
      const renderActivityTestError = () => {
        ...
        if (!message.error)
          return;
        return (h("div", { class: "elsa-ml-4" }, h("elsa-workflow-fault-information", { workflowFault: (_a = this.workflowInstance) === null || _a === void 0 ? void 0 : _a.fault, faultedAt: (_b = this.workflowInstance) === null || _b === void 0 ? void 0 : _b.faultedAt })));
      };
      ...
      return h("div", { "data-transition-enter": "elsa-transition elsa-ease-out elsa-duration-100", "data-transition-enter-start": "elsa-transform elsa-opacity-0 elsa-scale-95", "data-transition-enter-end": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave": "elsa-transition elsa-ease-in elsa-duration-75", "data-transition-leave-start": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave-end": "elsa-transform elsa-opacity-0 elsa-scale-95", class: `${this.activityContextMenuTestState.shown ? '' : 'hidden'} elsa-absolute elsa-z-10 elsa-mt-3 elsa-px-2 elsa-w-screen elsa-max-w-xl sm:elsa-px-0`, style: {
        ...
        }, ref: el => this.componentCustomButton = el }, h("div", { class: "elsa-rounded-lg elsa-shadow-lg elsa-ring-1 elsa-ring-black elsa-ring-opacity-5 elsa-overflow-hidden" }, !!message ? renderMessage() : renderLoader()));
    };
  ...
  render() {
    ...
    return (h(Host, { class: "elsa-flex elsa-flex-col elsa-w-full", ref: el => this.el = el }, h(Tunnel.Provider, { state: tunnelState }, this.renderCanvas(), this.renderActivityPicker(), this.renderActivityEditor())));
  }
  renderCanvas() {
    ...
    return (h("div", { class: "elsa-flex-1 elsa-flex elsa-relative" }, h("elsa-designer-tree", { model: this.workflowModel, mode: this.workflowDesignerMode, layoutDirection: this.layoutDirection, activityContextMenuButton: this.workflowDesignerMode == WorkflowDesignerMode.Edit
        ...
        ? this.activityContextMenuState
        : this.activityContextMenuTestState, enableMultipleConnectionsFromSingleSource: false, selectedActivityIds: [this.selectedActivityId], onActivitySelected: e => this.onActivitySelected(e), onActivityDeselected: e => this.onActivityDeselected(e), class: "elsa-flex-1", ref: el => this.designer = el }), this.renderWorkflowSettingsButton(), this.renderWorkflowHelpButton(), this.renderPanel(), this.renderActivityContextMenu(), h("elsa-workflow-settings-modal", { workflowDefinition: this.workflowDefinition }), h("elsa-workflow-definition-editor-notifications", null), h("div", { class: "elsa-fixed elsa-bottom-10 elsa-right-12" }, h("div", { class: "elsa-flex elsa-items-center elsa-space-x-4" }, this.renderSavingIndicator(), this.renderNetworkError(), this.renderPublishButton())), this.renderTestActivityMenu()));
  }
  ...
  renderTestPanel() {
    ...
    return [
      ...
      h("elsa-tab-content", { tab: "test", slot: "content" }, h("elsa-workflow-test-panel", { workflowDefinition: this.workflowDefinition, workflowTestActivityId: this.selectedActivityId }))
    ];
  }
