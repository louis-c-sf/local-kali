...
var LibFiles = class {
  ...
  getOrCreateModel(fileName) {
    ...
    const matchedLibFile = elsaActivityEditorModal_elsaActivityPickerModal_elsaControl_elsaDesignerPanel_elsaVersionHistoryPanel_elsaWorkflowPropertiesPanel_elsaWorkflowPublishButton_elsaWorkflowSettingsModal_elsaWorkflowTestPanel_entry.typescriptDefaults.getExtraLibs()[fileName];
    if (matchedLibFile) {
