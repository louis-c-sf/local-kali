...
export function textInput(context, fieldName, label, value, hint, fieldId) {
...
export function checkBox(context, fieldName, label, checked, hint, fieldId) {
  fieldId = fieldId || fieldName;
...
export function textArea(context, fieldName, label, value, hint, fieldId) {
  fieldId = fieldId || fieldName;
  return (h("div", null,
    h("label", { htmlFor: fieldName, class: "block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, label),
    h("div", { class: "elsa-mt-1" },
...
export function selectField(context, fieldName, label, value, options, hint, fieldId) {
  fieldId = fieldId || fieldName;
  return (h("div", null,
    h("label", { htmlFor: fieldName, class: "block elsa-text-sm elsa-font-medium elsa-text-gray-700" }, label),
    h("div", { class: "elsa-mt-1" },
...
export function updateField(context, fieldName, value) {
...
export function onTextInputChange(e, context) {
  const element = e.target;
  updateField(context, element.name, element.value.trim());
}
export function onTextAreaChange(e, context) {
  const element = e.target;
  updateField(context, element.name, element.value.trim());
}
export function onCheckBoxChange(e, context) {
  const element = e.target;
  updateField(context, element.name, element.checked);
}
export function onSelectChange(e, context) {
  const element = e.target;
  updateField(context, element.name, element.value.trim());
}
