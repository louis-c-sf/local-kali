...
export class ElsaActivityEditorModal {
  ...
  render() {
    ...
    return (h(Host, { class: "elsa-block" },
      h("elsa-modal-dialog", { ref: el => this.dialog = el, onShown: this.onDialogShown, onHidden: this.onDialogHidden },
        h("div", { slot: "content", class: "elsa-py-8 elsa-pb-0" },
          h("form", { onSubmit: e => this.onSubmit(e), key: this.timestamp.getTime().toString(), onKeyDown: this.onKeyDown, class: 'activity-editor-form' },
            h("div", { class: "elsa-flex elsa-px-8" },
              h("div", { class: "elsa-space-y-8 elsa-divide-y elsa-divide-gray-200 elsa-w-full" },
                h("div", null,
                  ...
                  h("div", { class: "elsa-mt-8" }, this.renderTabs(tabs))))),
            h("div", { class: "elsa-pt-5" },
              h("div", { class: "elsa-bg-gray-50 elsa-px-4 elsa-py-3 sm:elsa-px-6 sm:elsa-flex sm:elsa-flex-row-reverse" },
                h("button", { type: "submit", class: "elsa-ml-3 elsa-inline-flex elsa-justify-center elsa-py-2 elsa-px-4 elsa-border elsa-border-transparent elsa-shadow-sm elsa-text-sm elsa-font-medium elsa-rounded-md elsa-text-white elsa-bg-blue-600 hover:elsa-bg-blue-700 focus:elsa-outline-none focus:elsa-ring-2 focus:elsa-ring-offset-2 focus:elsa-ring-blue-500" }, t('Buttons.Save')),
                h("button", { type: "button", onClick: () => this.onCancelClick(), class: "elsa-w-full elsa-inline-flex elsa-justify-center elsa-rounded-md elsa-border elsa-border-gray-300 elsa-shadow-sm elsa-px-4 elsa-py-2 elsa-bg-white elsa-text-base elsa-font-medium elsa-text-gray-700 hover:elsa-bg-gray-50 focus:elsa-outline-none focus:elsa-ring-2 focus:elsa-ring-offset-2 focus:elsa-ring-blue-500 sm:elsa-mt-0 sm:elsa-ml-3 sm:elsa-w-auto sm:elsa-text-sm" }, t('Buttons.Cancel')))))),
        h("div", { slot: "buttons" }))));
  }
  renderTabs(tabs) {
    return tabs.map(x => (h("div", { class: `flex ${this.getHiddenClass(x.tabName)}` },
      h("elsa-control", { content: x.renderContent() }))));
  }
  renderStorageTab(activityModel, activityDescriptor) {
    ...
    return (h("div", { class: "elsa-space-y-8 elsa-w-full" },
      ...
      Object.keys(outputProperties).length > 0 ? ([section('Activity Output', 'Configure the desired storage for each output property of this activity.'), outputProperties.map(renderPropertyStorageSelectField)]) : undefined,
