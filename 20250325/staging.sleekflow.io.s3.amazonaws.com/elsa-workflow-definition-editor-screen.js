...
import { EventTypes, WorkflowPersistenceBehavior, WorkflowTestActivityMessageStatus, } from "../../../../models";
import { createElsaClient, eventBus, featuresDataManager } from "../../../../services";
import state from '../../../../utils/store';
import WorkflowEditorTunnel from '../../../../data/workflow-editor';
...
export class ElsaWorkflowDefinitionEditorScreen {
  constructor() {
    ...
    this.renderTestActivityMenu = () => {
      ...
      const renderActivityTestError = () => {
        ...
        if (!message.error)
          return;
        return (h("div", { class: "elsa-ml-4" },
          h("elsa-workflow-fault-information", { workflowFault: (_a = this.workflowInstance) === null || _a === void 0 ? void 0 : _a.fault, faultedAt: (_b = this.workflowInstance) === null || _b === void 0 ? void 0 : _b.faultedAt })));
      };
      const renderPerformanceStats = () => {
        if (!!message.error)
          return;
        return (h("div", { class: "elsa-ml-4" },
          h("elsa-workflow-performance-information", { activityStats: this.activityStats })));
      };
      ...
      const renderMessage = () => {
        ...
        return (h("div", { class: "elsa-relative elsa-grid elsa-gap-6 elsa-bg-white px-5 elsa-py-6 sm:elsa-gap-8 sm:elsa-p-8" },
          h("div", { class: "elsa-flex elsa-flex-row elsa-justify-between" },
            h("div", { class: "elsa-ml-4" },
              h("p", { class: "elsa-text-base elsa-font-medium elsa-text-gray-900" }, t('Status')),
              h("p", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500" }, message.status)),
            h("div", null, renderRestartButton())),
          collection.map(filteredData, (v, k) => (h("div", { class: "elsa-ml-4" },
            h("p", { class: "elsa-text-base elsa-font-medium elsa-text-gray-900" }, k),
            h("pre", { class: "elsa-mt-1 elsa-text-sm elsa-text-gray-500 elsa-overflow-x-auto" }, v)))),
      ...
      return h("div", { "data-transition-enter": "elsa-transition elsa-ease-out elsa-duration-100", "data-transition-enter-start": "elsa-transform elsa-opacity-0 elsa-scale-95", "data-transition-enter-end": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave": "elsa-transition elsa-ease-in elsa-duration-75", "data-transition-leave-start": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave-end": "elsa-transform elsa-opacity-0 elsa-scale-95", class: `${this.activityContextMenuTestState.shown ? '' : 'hidden'} elsa-absolute elsa-z-10 elsa-mt-3 elsa-px-2 elsa-w-screen elsa-max-w-xl sm:elsa-px-0`, style: {
        ...
        h("div", { class: "elsa-rounded-lg elsa-shadow-lg elsa-ring-1 elsa-ring-black elsa-ring-opacity-5 elsa-overflow-hidden" }, !!message ? renderMessage() : renderLoader()));
    };
    ...
    this.renderDesignerPanel = () => {
      ...
      if (isFeaturePanelVisible) {
        return [
          ...
          h("elsa-tab-content", { tab: "designer", slot: "content" },
            h("elsa-designer-panel", { onFeatureChanged: this.handleFeatureChange, onFeatureStatusChanged: this.handleFeatureStatusChange }))
        ];
      }
    };
    this.renderVersionHistoryPanel = (workflowDefinition) => {
      return [
        ...
        h("elsa-tab-content", { tab: "versionHistory", slot: "content" },
          h("elsa-version-history-panel", { workflowDefinition: workflowDefinition, onVersionSelected: e => this.onVersionSelected(e), onDeleteVersionClicked: e => this.onDeleteVersionClicked(e), onRevertVersionClicked: e => this.onRevertVersionClicked(e) }))
      ];
    };
  ...
  render() {
    ...
    return (h(Host, { class: "elsa-flex elsa-flex-col elsa-w-full", ref: el => this.el = el },
      h(WorkflowEditorTunnel.Provider, { state: tunnelState },
        this.renderCanvas(),
  ...
  renderCanvas() {
    ...
    return (h("div", { class: "elsa-flex-1 elsa-flex elsa-relative" },
      h("elsa-designer-tree", { model: this.workflowModel, mode: this.workflowDesignerMode, layoutDirection: this.layoutDirection, activityContextMenuButton: this.workflowDesignerMode == WorkflowDesignerMode.Edit
          ? activityContextMenuButton
          : this.renderActivityStatsButton, onActivityContextMenuButtonClicked: e => this.onActivityContextMenuButtonClicked(e), onActivityContextMenuButtonTestClicked: e => this.onActivityContextMenuButtonTestClicked(e), activityContextMenu: this.workflowDesignerMode == WorkflowDesignerMode.Edit
          ? this.activityContextMenuState
          : this.activityContextMenuTestState, enableMultipleConnectionsFromSingleSource: false, selectedActivityIds: [this.selectedActivityId], onActivitySelected: e => this.onActivitySelected(e), onActivityDeselected: e => this.onActivityDeselected(e), class: "elsa-flex-1", ref: el => this.designer = el }),
    ...
    return h("div", { "data-transition-enter": "elsa-transition elsa-ease-out elsa-duration-100", "data-transition-enter-start": "elsa-transform elsa-opacity-0 elsa-scale-95", "data-transition-enter-end": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave": "elsa-transition elsa-ease-in elsa-duration-75", "data-transition-leave-start": "elsa-transform elsa-opacity-100 elsa-scale-100", "data-transition-leave-end": "elsa-transform elsa-opacity-0 elsa-scale-95", class: `${this.activityContextMenuState.shown ? '' : 'hidden'} context-menu elsa-z-10 elsa-mx-3 elsa-w-48 elsa-mt-1 elsa-rounded-md elsa-shadow-lg elsa-fixed`, style: { left: `${this.activityContextMenuState.x}px`, top: `${this.activityContextMenuState.y}px` }, ref: el => this.activityContextMenu = el },
      h("div", { class: "elsa-rounded-md elsa-bg-white elsa-shadow-xs", role: "menu", "aria-orientation": "vertical", "aria-labelledby": "pinned-project-options-menu-0" },
        h("div", { class: "elsa-py-1" },
          h("a", { onClick: e => this.onEditActivityClick(e), href: "#", class: "elsa-block elsa-px-4 elsa-py-2 elsa-text-sm elsa-leading-5 elsa-text-gray-700 hover:elsa-bg-gray-100 hover:elsa-text-gray-900 focus:elsa-outline-none focus:elsa-bg-gray-100 focus:elsa-text-gray-900", role: "menuitem" }, t('ActivityContextMenu.Edit'))),
        h("div", { class: "elsa-border-t elsa-border-gray-100" }),
        h("div", { class: "elsa-py-1" },
          h("a", { onClick: e => this.onDeleteActivityClick(e), href: "#", class: "elsa-block elsa-px-4 elsa-py-2 elsa-text-sm elsa-leading-5 elsa-text-gray-700 hover:elsa-bg-gray-100 hover:elsa-text-gray-900 focus:elsa-outline-none focus:elsa-bg-gray-100 focus:elsa-text-gray-900", role: "menuitem" }, (selectedActivities.length > 1 && selectedActivities.indexOf(activity.activityId) !== -1) ? t('ActivityContextMenu.DeleteSelected') : t('ActivityContextMenu.Delete')))));
  }
  ...
  renderWorkflowHelpButton() {
    return (h("span", null,
      h("button", { type: "button", onClick: this.showHelpModal, class: "workflow-settings-button elsa-fixed elsa-top-20 elsa-right-28 elsa-inline-flex elsa-items-center elsa-p-2 elsa-rounded-full elsa-border elsa-border-transparent elsa-bg-white shadow elsa-text-gray-400 hover:elsa-text-blue-500 focus:elsa-text-blue-500 hover:elsa-ring-2 hover:elsa-ring-offset-2 hover:elsa-ring-blue-500 focus:elsa-outline-none focus:elsa-ring-2 focus:elsa-ring-offset-2 focus:elsa-ring-blue-500" },
      ...
      h("elsa-modal-dialog", { ref: el => this.helpDialog = el },
        h("div", { slot: "content", class: "elsa-p-8" },
          h("h3", { class: "elsa-text-lg elsa-font-medium" }, "Actions"),
          h("dl", { class: "elsa-mt-2 elsa-border-t elsa-border-b elsa-border-gray-200 elsa-divide-y elsa-divide-gray-200" },
            h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" },
              h("dt", { class: "elsa-text-gray-500" }, "Delete connections"),
              h("dd", { class: "elsa-text-gray-900" }, "RIGHT-click the connection to delete.")),
            h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" },
              h("dt", { class: "elsa-text-gray-500" }, "Connect outcomes to existing activity"),
              h("dd", { class: "elsa-text-gray-900" }, "Press and hold SHIFT while LEFT-clicking the outcome to connect. Release SHIFT and LEFT-click the target activity.")),
            h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" },
              h("dt", { class: "elsa-text-gray-500" }, "Pan"),
              h("dd", { class: "elsa-text-gray-900" }, "Click anywhere on the designer and drag mouse.")),
            h("div", { class: "elsa-py-3 elsa-flex elsa-justify-between elsa-text-sm elsa-font-medium" },
              h("dt", { class: "elsa-text-gray-500" }, "Zoom"),
              h("dd", { class: "elsa-text-gray-900" }, "Use scroll-wheel on mouse.")))))));
  }
  ...
  renderPanel() {
    const workflowDefinition = this.workflowDefinition;
    return (h("elsa-flyout-panel", { expandButtonPosition: 3 },
      h("elsa-tab-header", { tab: "general", slot: "header" }, "General"),
      h("elsa-tab-content", { tab: "general", slot: "content" },
        h("elsa-workflow-properties-panel", { workflowDefinition: workflowDefinition })),
  ...
  renderTestPanel() {
    ...
    return [
      ...
      h("elsa-tab-content", { tab: "test", slot: "content" },
        h("elsa-workflow-test-panel", { workflowDefinition: this.workflowDefinition, workflowTestActivityId: this.selectedActivityId }))
    ];
  }
  static get is() { return "elsa-workflow-definition-editor-screen"; }
  static get originalStyleUrls() { return {
    "$": ["elsa-workflow-definition-editor-screen.css"]
  }; }
