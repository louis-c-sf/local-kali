...
export class ElsaScriptProperty {
  ...
  render() {
    ...
    const renderValidationResult = () => {
      ...
      return (h("div", { class: "elsa-mt-3" },
        h("p", { class: `elsa-mt-1 elsa-text-sm elsa-text-${color}-500` }, this.activityValidatingContext.data)));
    };
