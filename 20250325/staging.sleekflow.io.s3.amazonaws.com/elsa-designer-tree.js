...
export class ElsaWorkflowDesigner {
  ...
  applyInitialZoom() {
    ...
    const nodeStartTransform = d3.select('.node.start').attr('transform');
  ...
  render() {
    return (h(Host, { class: "workflow-canvas elsa-flex-1 elsa-flex", ref: el => (this.el = el) },
      this.mode == WorkflowDesignerMode.Test ?
        h("div", null,
          h("div", { id: "left", style: { border: `4px solid orange`, position: `fixed`, height: `calc(100vh - 64px)`, width: `4px`, top: `64`, bottom: `0`, left: `0` } }),
          h("div", { id: "right", style: { border: `4px solid orange`, position: `fixed`, height: `calc(100vh - 64px)`, width: `4px`, top: `64`, bottom: `0`, right: `0` } }),
          h("div", { id: "top", style: { border: `4px solid orange`, position: `fixed`, height: `4px`, left: `0`, right: `0`, top: `30` } }),
          h("div", { id: "bottom", style: { border: `4px solid orange`, position: `fixed`, height: `4px`, left: `0`, right: `0`, bottom: `0` } }))
        :
          undefined,
      h("svg", { ref: (el) => (this.svg = el), id: "svg", style: {
  ...
  static get properties() { return {
    ...
    "mode": {
      ...
      "complexType": {
        ...
        "resolved": "WorkflowDesignerMode.Blueprint | WorkflowDesignerMode.Edit | WorkflowDesignerMode.Instance | WorkflowDesignerMode.Test",
        "references": {
    ...
    "layoutDirection": {
      ...
      "complexType": {
        ...
        "resolved": "LayoutDirection.BottomTop | LayoutDirection.LeftRight | LayoutDirection.RightLeft | LayoutDirection.TopBottom",
        "references": {
          "LayoutDirection": {
            "location": "import",
            "path": "./models"
      ...
      "reflect": false,
      "defaultValue": "LayoutDirection.TopBottom"
    },
    "enableMultipleConnectionsFromSingleSource": {
      ...
      "attribute": "enable-multiple-connections",
      "reflect": false
    }
  }; }
  ...
  static get events() { return [{
      ...
      "method": "connectionContextMenuButtonClicked",
      "name": "connectionContextMenuButtonClicked",
      "bubbles": true,
      "cancelable": true,
      "composed": true,
      "docs": {
      ...
      "method": "activityContextMenuButtonTestClicked",
      "name": "activityContextMenuButtonTestClicked",
      "bubbles": true,
      "cancelable": true,
      "composed": true,
      "docs": {
  ...
  static get watchers() { return [{
      ...
      "propName": "connectionContextMenu",
      "methodName": "handleConnectionContextMenuChanged"
    }, {
      "propName": "activityContextTestMenu",
      "methodName": "handleActivityContextMenuTestChanged"
    }]; }
}
