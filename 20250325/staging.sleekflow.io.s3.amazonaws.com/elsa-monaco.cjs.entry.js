...
let ElsaMonaco = class {
  ...
  async componentWillLoad() {
    var _a;
    const monacoLibPath = (_a = this.monacoLibPath) !== null && _a !== void 0 ? _a : store.state.monacoLibPath;
  ...
  render() {
    ...
    return (index.h(index.Host, { class: "elsa-monaco-editor-host elsa-border focus:elsa-ring-blue-500 focus:elsa-border-blue-500 elsa-block elsa-w-full elsa-min-w-0 elsa-rounded-md sm:elsa-text-sm elsa-border-gray-300 elsa-p-4", style: { 'min-height': this.editorHeight } }, index.h("div", { ref: el => this.container = el, class: `elsa-monaco-editor-container ${padding}` })));
  }
...
exports.elsa_monaco = ElsaMonaco;
