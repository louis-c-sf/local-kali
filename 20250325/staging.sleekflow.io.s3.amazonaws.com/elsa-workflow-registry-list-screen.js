...
export class ElsaWorkflowRegistryListScreen {
  ...
  render() {
    ...
    const renderContextMenu = (workflowBlueprintId, isWorkflowBlueprintDisabled, history, editUrl, editIcon, enableIcon, disableIcon) => {
      ...
      return (h("td", { class: "elsa-pr-6" },
        h("elsa-context-menu", { history: history, menuItems: menuItems })));
    };
    return (h("div", null,
      h("div", { class: "elsa-p-8 elsa-flex elsa-content-end elsa-justify-right elsa-bg-white elsa-space-x-4" },
        h("div", { class: "elsa-flex-shrink-0" }, this.renderWorkflowProviderFilter())),
      h("div", { class: "elsa-align-middle elsa-inline-block elsa-min-w-full elsa-border-b elsa-border-gray-200" },
        h("table", { class: "elsa-min-w-full" },
          ...
          h("tbody", { class: "elsa-bg-white elsa-divide-y elsa-divide-gray-100" }, collection.map(groupings, group => {
            ...
            const enableIcon = (h("svg", { class: "elsa-h-5 elsa-w-5 elsa-text-gray-500", width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
              h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
              h("path", { d: "M5 12l5 5l10 -10" })));
            const disableIcon = (h("svg", { class: "elsa-h-5 elsa-w-5 elsa-text-gray-500", width: "24", height: "24", viewBox: "0 0 24 24", "stroke-width": "2", stroke: "currentColor", fill: "none", "stroke-linecap": "round", "stroke-linejoin": "round" },
              h("path", { stroke: "none", d: "M0 0h24v24H0z" }),
              h("circle", { cx: "12", cy: "12", r: "9" }),
              h("line", { x1: "5.7", y1: "5.7", x2: "18.3", y2: "18.3" })));
            return (h("tr", null,
