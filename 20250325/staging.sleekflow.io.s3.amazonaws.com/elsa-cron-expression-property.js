...
export class ElsaCronExpressionProperty {
  ...
  render() {
    ...
    return (h("elsa-property-editor", { activityModel: this.activityModel, propertyDescriptor: propertyDescriptor, propertyModel: propertyModel, onDefaultSyntaxValueChanged: e => this.onDefaultSyntaxValueChanged(e), "editor-height": "5em", "single-line": true },
      h("div", null,
        ...
        h("p", { class: "elsa-mt-2 elsa-text-sm elsa-text-gray-500" }, this.valueDescription))));
  }
  static get is() { return "elsa-cron-expression-property"; }
