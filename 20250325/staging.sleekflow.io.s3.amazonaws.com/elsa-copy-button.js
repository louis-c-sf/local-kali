...
export class ElsaCopyButton {
  ...
  render() {
    return (h(Host, { class: "elsa-align-text-top elsa-inline-block" },
      h("button", { type: "button", class: "hover:elsa-text-blue-500 focus:elsa-text-green-600 elsa-pl-0.5", onClick: this.onCopyClick },
        h("svg", { xmlns: "http://www.w3.org/2000/svg", class: "elsa-h-4 elsa-w-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
